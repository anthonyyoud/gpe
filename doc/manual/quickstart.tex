...
\begin{chapter}{\label{cha:quickstart}Getting started}
  ...
  quota restrictions (as would be the case for a network mounted \verb"/home"
  ...
  The second, \gpevar{/cntr}, is a keyword which turns on contour output, rather
  ...
  Now do exactly as in section~\ref{subsec:contour_plots}, but this time leave
  off the \gpevar{/cntr} keyword.
