...
\begin{chapter}{\label{cha:numerics}Numerical formulation}
  ...
  setting the parameter \verb"scheme" equal to \verb"euler".  See chapter
  SOMETHING OR OTHER for a full description of the parameters which can be set.
  ...
  \end{equation*}
  %
  This scheme can be selected by setting \verb"scheme" equal to \verb"rk2".

  \subsection{Fourth-order Runge--Kutta method}
  The fourth-order Runge--Kutta method is second order accurate in time and
  takes the form
  %
  \begin{equation*}
  ...
  \end{equation*}
  %
  This scheme can be selected by setting \verb"scheme" equal to \verb"rk4".
  ...
  This scheme can be selected by setting \verb"scheme" equal to \verb"rk45".
  ...
  The second-order finite-difference approximation to the first derivative with
  ...
  \end{equation*}
  %
  Second-order finite differences can be chosen by setting \verb"order" equal
  to \verb"2".

  \subsection{Fourth-order finite differences}
  The fourth-order finite-difference approximation to the first derivative with
  respect to $x$ is given by
  %
  \begin{equation*}
  ...
  \end{equation*}
  %
  Fourth-order finite differences can be chosen by setting \verb"order" equal
  to \verb"4".
  ...
  To use periodic boundary conditions set \verb"bcs" equal to \verb"1".
  ...
  \end{equation*}
  %
  To use reflective boundary conditions set \verb"bcs" equal to \verb"2".
\end{chapter}
